...
#15/01/19
#Script to count, SSU and LSU around the first ATG found in the leader region.
#Take the first ATG uORF
#Plot 100nt up and downstream of it
#Store the uORF stop codon. And SSU and LSU sums of the CDSs

#plot 100 nt upstream of TIS for all genes with leaders greater than 100nt
#plot 200 nt upstream of TIS for all genes with leaders greater than 200nt
#plot 500 nt upstream of TIS for all genes with leaders greater than 500nt
...
my %TIS_100_window_search_fwd;
my %TIS_200_window_search_fwd;
my %TIS_500_window_search_fwd;
my %TIS_100_window_search_rev;
my %TIS_200_window_search_rev;
my %TIS_500_window_search_rev;

my %TIS_100_SSU_coverage_by_positon;
my %TIS_100_SSU_3prime_counts_by_positon;
my %TIS_100_SSU_5prime_counts_by_positon;

my %TIS_100_LSU_3prime_counts_by_positon;
my %TIS_100_LSU_5prime_counts_by_positon;
my %TIS_100_LSU_coverage_by_positon;

my %TIS_200_SSU_coverage_by_positon;
my %TIS_200_SSU_3prime_counts_by_positon;
my %TIS_200_SSU_5prime_counts_by_positon;

my %TIS_200_LSU_3prime_counts_by_positon;
my %TIS_200_LSU_5prime_counts_by_positon;
my %TIS_200_LSU_coverage_by_positon;

my %TIS_500_SSU_coverage_by_positon;
my %TIS_500_SSU_3prime_counts_by_positon;
my %TIS_500_SSU_5prime_counts_by_positon;

my %TIS_500_LSU_3prime_counts_by_positon;
my %TIS_500_LSU_5prime_counts_by_positon;
my %TIS_500_LSU_coverage_by_positon;
        ...
        if ($coord >= $five_prime_most_coord_fwd{$gene}){
            ...
            if ($coord == $start_coord){   
                ...
                if ($start_coord-$TSS_coord > 100){ #check that there the leader is at least 100nt long
                    my $relational_position=-100; #1 to 100 window upstream and downsteam
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_fwd{$gene}{($start_coord+$relational_position)};
                        $TIS_100_window_search_fwd{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_100_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_SSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_LSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $relational_position++;
                    }
                }

                if ($start_coord-$TSS_coord > 200){ #check that there the leader is at least 100nt long
                    my $relational_position=-200; #1 to 100 window upstream and downsteam
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_fwd{$gene}{($start_coord+$relational_position)};
                        $TIS_200_window_search_fwd{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_200_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_SSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_LSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $relational_position++;
                    }
                }

                if ($start_coord-$TSS_coord > 500){ #check that there the leader is at least 100nt long
                    my $relational_position=-500; #1 to 100 window upstream and downsteam
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_fwd{$gene}{($start_coord+$relational_position)};
                        $TIS_500_window_search_fwd{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_500_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_SSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_LSU_5prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $relational_position++;
                    }
                }
            } 
        ...
        if ($coord >= $five_prime_most_coord_rev{$gene}){
            ...
            if ($coord == $start_coord){   
                ...
                if ($start_coord-$TSS_coord > 100){ #check that there the leader is at least 100nt long
                    my $relational_position=-100; #1 to 100 window upstream and downsteam
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_rev{$gene}{($start_coord+$relational_position)};
                        $TIS_100_window_search_rev{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_100_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_100_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                ...
                if ($start_coord-$TSS_coord > 200){ #check that there the leader is at least 100nt long
                    ...
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_rev{$gene}{($start_coord+$relational_position)};
                        $TIS_200_window_search_rev{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_200_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_200_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                ...
                if ($start_coord-$TSS_coord > 500){ #check that there the leader is at least 100nt long
                    ...
                    while ($relational_position < 100){
                        my $genomic_position=$gene_model_rev{$gene}{($start_coord+$relational_position)};
                        $TIS_500_window_search_rev{$chr}{$genomic_position}=$gene."~".$relational_position;
                        $TIS_500_SSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_LSU_coverage_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_SSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
                        $TIS_500_LSU_3prime_counts_by_positon{$gene}{$relational_position}=0; #initialise
    ...
    unless ($flag & 0x4){   #if aligned
        ...
        if ($mapq >= 10){     #mapping uniqnes filter
            ...
            if ($flag & 0x10){  #Reverse reads. Starting from the leftmost position parse the cigar and check if it matches a uORF
                ...
                if (exists ($TIS_100_window_search_rev{$chr}{$threePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$threePrime});
                    $TIS_100_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_rev{$chr}{$threePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$threePrime});
                    $TIS_200_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_rev{$chr}{$threePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$threePrime});
                    $TIS_500_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                ...
                if (exists ($TIS_100_window_search_rev{$chr}{$fivePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$fivePrime});
                    $TIS_100_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_rev{$chr}{$fivePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$fivePrime});
                    $TIS_200_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_rev{$chr}{$fivePrime})){
                    my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$fivePrime});
                    $TIS_500_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                    ...
                    if ($cigar =~ /^([0-9]+[MIDN])/){
                        ...
                        if ($cigar_part =~ /(\d+)M/){   #alignment matching 
                            for my $pos ($leftMost .. ($leftMost+$1-1)){ #search though this position
                                ...
                                if (exists ($TIS_100_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$pos});
                                    $TIS_100_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }

                                if (exists ($TIS_200_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$pos});
                                    $TIS_200_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }

                                if (exists ($TIS_500_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$pos});
                                    $TIS_500_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }
                ...
                if (exists ($TIS_100_window_search_fwd{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_100_window_search_fwd{$chr}{$threePrime});
                     $TIS_100_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_fwd{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_200_window_search_fwd{$chr}{$threePrime});
                     $TIS_200_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_fwd{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_500_window_search_fwd{$chr}{$threePrime});
                     $TIS_500_SSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                ...
                if (exists ($TIS_100_window_search_fwd{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_100_window_search_fwd{$chr}{$fivePrime});
                     $TIS_100_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_fwd{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_200_window_search_fwd{$chr}{$fivePrime});
                     $TIS_200_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_fwd{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_500_window_search_fwd{$chr}{$fivePrime});
                     $TIS_500_SSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                    ...
                    if ($cigar =~ /^([0-9]+[MIDN])/){
                        ...
                        if ($cigar_part =~ /(\d+)M/){   #alignment matching 
                            for my $pos ($leftMost .. ($leftMost+$1-1)){ #search though this position
                                ...
                                if (exists ($TIS_100_window_search_fwd{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_100_window_search_fwd{$chr}{$pos});
                                    $TIS_100_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }

                                if (exists ($TIS_200_window_search_fwd{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_200_window_search_fwd{$chr}{$pos});
                                    $TIS_200_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }                                

                                if (exists ($TIS_500_window_search_fwd{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_500_window_search_fwd{$chr}{$pos});
                                    $TIS_500_SSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }
    ...
    unless ($flag & 0x4){   #if aligned
        ...
        if ($mapq >= 10){     #mapping uniqnes filter
            ...
            if ($flag & 0x10){  #Reverse reads. Starting from the leftmost position parse the cigar and check if it matches a uORF
                ...
                if (exists ($TIS_100_window_search_rev{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$threePrime});
                     $TIS_100_LSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_rev{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$threePrime});
                     $TIS_200_LSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_rev{$chr}{$threePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$threePrime});
                     $TIS_500_LSU_3prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                ...
                if (exists ($TIS_100_window_search_rev{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$fivePrime});
                     $TIS_100_LSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_200_window_search_rev{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$fivePrime});
                     $TIS_200_LSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }

                if (exists ($TIS_500_window_search_rev{$chr}{$fivePrime})){
                     my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$fivePrime});
                     $TIS_500_LSU_5prime_counts_by_positon{$gene}{$meta_pos}++;
                }
                    ...
                    if ($cigar =~ /^([0-9]+[MIDN])/){
                        ...
                        if ($cigar_part =~ /(\d+)M/){   #alignment matching 
                            for my $pos ($leftMost .. ($leftMost+$1-1)){ #search though this position
                                ...
                                if (exists ($TIS_100_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_100_window_search_rev{$chr}{$pos});
                                    $TIS_100_LSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }

                                if (exists ($TIS_200_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_200_window_search_rev{$chr}{$pos});
                                    $TIS_200_LSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }

                                if (exists ($TIS_500_window_search_rev{$chr}{$pos})){
                                    my ($gene,$meta_pos)=split("~", $TIS_500_window_search_rev{$chr}{$pos});
                                    $TIS_500_LSU_coverage_by_positon{$gene}{$meta_pos}++;
                                }
...
my $out_file1 = $outdir."/TIS_coverage_100.csv";
my $out_file2 = $outdir."/TIS_coverage_200.csv";
my $out_file3 = $outdir."/TIS_coverage_500.csv";
my $out_file4 = $outdir."/transcript_coverage.csv";

my $out_file5 = $outdir."/TIS_3prime_100.csv";
my $out_file6 = $outdir."/TIS_3prime_200.csv";
my $out_file7 = $outdir."/TIS_3prime_500.csv";
my $out_file8 = $outdir."/transcript_3prime.csv";

my $out_file9  = $outdir."/TIS_5prime_100.csv";
my $out_file10 = $outdir."/TIS_5prime_200.csv";
my $out_file11 = $outdir."/TIS_5prime_500.csv";
...
for my $gene (keys %TIS_100_SSU_coverage_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_100_SSU_coverage_by_positon{$gene}}){ 
        print OUT1 "$gene_info,SSU,$pos,$TIS_100_SSU_coverage_by_positon{$gene}{$pos}\n"; 
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_100_LSU_coverage_by_positon{$gene}}){
        print OUT1 "$gene_info,LSU,$pos,$TIS_100_LSU_coverage_by_positon{$gene}{$pos}\n"; 
    }
}
close(OUT1);
...
for my $gene (keys %TIS_200_SSU_coverage_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_200_SSU_coverage_by_positon{$gene}}){
        print OUT2 "$gene_info,SSU,$pos,$TIS_200_SSU_coverage_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_200_LSU_coverage_by_positon{$gene}}){
        print OUT2 "$gene_info,LSU,$pos,$TIS_200_LSU_coverage_by_positon{$gene}{$pos}\n";
    }
}
close(OUT2);
...
for my $gene (keys %TIS_500_SSU_coverage_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_500_SSU_coverage_by_positon{$gene}}){
        print OUT3 "$gene_info,SSU,$pos,$TIS_500_SSU_coverage_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_500_LSU_coverage_by_positon{$gene}}){
        print OUT3 "$gene_info,LSU,$pos,$TIS_500_LSU_coverage_by_positon{$gene}{$pos}\n";
    }
}
close(OUT3);
...
for my $gene (keys %TIS_100_SSU_3prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_100_SSU_3prime_counts_by_positon{$gene}}){
        print OUT5 "$gene_info,SSU,$pos,$TIS_100_SSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_100_LSU_3prime_counts_by_positon{$gene}}){
        print OUT5 "$gene_info,LSU,$pos,$TIS_100_LSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT5);
...
for my $gene (keys %TIS_200_SSU_3prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_200_SSU_3prime_counts_by_positon{$gene}}){
        print OUT6 "$gene_info,SSU,$pos,$TIS_200_SSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_200_LSU_3prime_counts_by_positon{$gene}}){
        print OUT6 "$gene_info,LSU,$pos,$TIS_200_LSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT6);
...
for my $gene (keys %TIS_500_SSU_3prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_500_SSU_3prime_counts_by_positon{$gene}}){
        print OUT7 "$gene_info,SSU,$pos,$TIS_500_SSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_500_LSU_3prime_counts_by_positon{$gene}}){
        print OUT7 "$gene_info,LSU,$pos,$TIS_500_LSU_3prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT7);
...
for my $gene (keys %TIS_100_SSU_5prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_100_SSU_5prime_counts_by_positon{$gene}}){
        print OUT9 "$gene_info,SSU,$pos,$TIS_100_SSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_100_LSU_5prime_counts_by_positon{$gene}}){
        print OUT9 "$gene_info,LSU,$pos,$TIS_100_LSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT9);
...
for my $gene (keys %TIS_200_SSU_5prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_200_SSU_5prime_counts_by_positon{$gene}}){
        print OUT10 "$gene_info,SSU,$pos,$TIS_200_SSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_200_LSU_5prime_counts_by_positon{$gene}}){
        print OUT10 "$gene_info,LSU,$pos,$TIS_200_LSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT10);
...
for my $gene (keys %TIS_500_SSU_5prime_counts_by_positon){
    ...
    for my $pos (sort {$a <=> $b} keys %{$TIS_500_SSU_5prime_counts_by_positon{$gene}}){
        print OUT11 "$gene_info,SSU,$pos,$TIS_500_SSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }

    for my $pos (sort {$a <=> $b} keys %{$TIS_500_LSU_5prime_counts_by_positon{$gene}}){
        print OUT11 "$gene_info,LSU,$pos,$TIS_500_LSU_5prime_counts_by_positon{$gene}{$pos}\n";
    }
}
close(OUT11);
