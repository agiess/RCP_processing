...
#calulcate TISU score for all genes
#Plot tisu 5' regions by filtering on length + tisu score

#plot 100 nt downstream of TSS for all genes with transcripts greater than 100nt
#plot 200 nt downstream of TSS for all genes with transcripts greater than 200nt
#plot 500 nt downstream of TSS for all genes with transcripts greater than 500nt
...
for my $gene (keys %gene_model_fwd){
    ...
    $leader_length{$gene}=($start_coord-$TSS_coord)+1;

    my $relational_position=0;
    my @TIS_window;

    #score the TISU context of the gene
    ...
    for(-4 .. 7){  #4 downstream, 5 after TIS
        if (exists ($gene_model_fwd{$gene}{ ($start_coord+$_) } )){
            if (($start_coord+$_) >= ($five_prime_most_coord_fwd{$gene}-1)){ #check we're not going behyond the leader
    ...
    $TISU_score{$gene}=$tisu_strength;


    #take all transcripts regardless of leader length
    #filter on tisu score + leader length when plotting
    #just filter on transcript length
    ...
    for my $coord (sort {$a <=> $b} keys %{ $gene_model_fwd{$gene} } ){
        if ($coord >= $five_prime_most_coord_fwd{$gene}){
            ...
            if ($coord == $TSS_coord){   
                ...
                if ($TTS_coord-$TSS_coord > 200){ #check that there the leader is at least 100nt long
                    my $relational_position=0; #1 to 100 window upstream and downsteam
                ...
                if ($TTS_coord-$TSS_coord > 500){ #check that there the leader is at least 100nt long
                    my $relational_position=0; #1 to 100 window upstream and downsteam
...
for my $gene (keys %gene_model_rev){
    ...
    for(-4 .. 7){  #4 downstream, 5 after TIS
        if (exists ($gene_model_rev{$gene}{ ($start_coord+$_) } )){
            if (($start_coord+$_) >= ($five_prime_most_coord_rev{$gene}-1)){ #check we're not going behyond the leader
...
print OUT1 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
for my $gene (keys %TSS_100_SSU_coverage_by_positon){
    ...
    my $gene_info="$gene,$transcript_counts_SSU{$gene},$transcript_counts_LSU{$gene},$CDS_counts_SSU{$gene},$CDS_counts_LSU{$gene},$CDS_TCPseq_SSU_FPKM,$CDS_TCPseq_LSU_FPKM,$transcript_length,$cds_length,$leader_length,$tisu_score,$gene_overlaps_another_gene,$leader_overlap_an_upstream_gene,$trailer_overlaps_a_downstream_gene,$gene_overlaps_ncRNA";
...
print OUT2 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT3 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT5 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT6 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT7 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT9 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT10 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
...
print OUT11 "gene_id,transcript_SSU_count,transcript_LSU_count,cds_SSU_count,cds_LSU_count,cds_SSU_FPKM,cds_LSU_FPKM,transcript_length,cds_length,leader_length,tisu_score,gene_overlaps_another_gene,leader_overlap_an_upstream_gene,trailer_overlaps_a_downstream_gene,gene_overlaps_ncRNA,fraction,position_in_region,count\n";
